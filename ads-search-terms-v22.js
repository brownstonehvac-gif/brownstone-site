...
var CONFIG = {
  ...
  WEBAPP_URL:    'https://script.google.com/macros/s/AKfycbwCcJ4IHSpCGbuyAcRF-ydFjn9bioFAkhbNTN8hfe4NYKA73lbYfkDpUXTSmUvUNM4b/exec',
...
function sendReport(counters, today, yesterday, yesterdayList, newCount, blockedCount,
  ...
  var body = '<div style="font-family:sans-serif;max-width:700px;color:#111">'
    ...
    + negHtml
    + '<p style="color:#bbb;font-size:11px;margin-top:20px">v22 — Brownstone HVAC</p></div>';
