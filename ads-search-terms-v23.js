// ════════════════════════════════════════════════════════════════════════════
//  BROWNSTONE — Daily Search Term Report  v23
//  Changes vs v22:
//  - Adds TODAY section (live/partial) above the Yesterday section
//  - GAQL date range now extends through today so live terms appear
//  - WEBAPP_URL on line 16: if buttons show "unable to open the file",
//    go to script.google.com → Deploy → New deployment → paste new URL here
// ════════════════════════════════════════════════════════════════════════════
...
function sendReport(counters, today, yesterday,
  ...
  var body = '<div style="font-family:sans-serif;max-width:700px;color:#111">'
    ...
    + negHtml
    + '<p style="color:#bbb;font-size:11px;margin-top:20px">v23 — Brownstone HVAC</p></div>';
