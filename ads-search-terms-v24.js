// ════════════════════════════════════════════════════════════════════════════
//  BROWNSTONE — Daily Search Term Report  v24
//  Changes vs v23:
//  - FIXES email buttons on Gmail mobile. Root cause: Gmail rewrites tapped
//    links through google.com/url?q=... and splits on the first "&", which
//    tore the term+secret off our 3-parameter button URLs → "can't open file".
//    Now all params are packed into ONE base64 token (?d=...) so there is no
//    "&" for Gmail to break on. REQUIRES the matching Apps Script doGet update
//    (decodes the ?d= token) — paste the companion script too.
// ════════════════════════════════════════════════════════════════════════════
...
function sendReport(counters, today, yesterday,
  ...
  var body = '<div style="font-family:sans-serif;max-width:700px;color:#111">'
    ...
    + negHtml
    + '<p style="color:#bbb;font-size:11px;margin-top:20px">v24 — Brownstone HVAC</p></div>';
